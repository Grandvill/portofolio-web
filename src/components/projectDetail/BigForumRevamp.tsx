...
const projectsData: Record<string, ProjectData> = {
  bigforum: {
    ...
    fullDescription:
      'BIG Forum Revamp is a complete overhaul of the legacy BigForum system, developed for Bisnis Indonesia Group. The main objective of this project was to modernize the user interface, improve system performance, and create a more intuitive experience for internal users. Built with Next.js and TailwindCSS, the platform delivers a responsive and accessible design, while the backend powered by Node.js, Express.js, and PostgreSQL ensures scalability and reliability. BIG Forum serves as an internal hub that integrates essential features such as company profiles, financial data management, document sharing, and internal communication, making it easier for the organization to manage information in a centralized and structured way.',
    ...
    features: [
      ...
      '🏢 Company profile and internal content management',
      '💰 Financial data management module',
      '📂 Document and resource sharing',
      '📊 Dashboard with structured information display',
      '⚡ Modern UI with TailwindCSS',
      '🌐 Built on Next.js for performance and SEO optimization',
      '🗄️ Scalable backend powered by Node.js and PostgreSQL',
    ],
    gallery: [
      '../images/projects/loginbigforum.jpg',
      '../images/projects/bigforum/dashboardbigforum.png',
      '../images/projects/bigforum/profilbigforum.png',
      '../images/projects/bigforum/dokumen.png',
      '../images/projects/bigforum/extension.png',
      '../images/projects/bigforum/iklan.png',
      '../images/projects/bigforum/rapatbigforum.png',
    ],
  },
};
