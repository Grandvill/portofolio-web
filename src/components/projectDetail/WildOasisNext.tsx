...
const projectsData: Record<string, ProjectData> = {
  'wild-oasis-next': {
    ...
    features: [
      ...
      'Cabin browsing with detailed descriptions and images',
      'Availability check with date-based filtering',
      'Booking management system',
      'Server-side data fetching with Supabase',
      'Responsive design optimized for mobile and desktop',
    ],
    gallery: [
      '../images/projects/wild-oasis-next.png',
      '../images/projects/wild-oasis-next/cabins.png',
      '../images/projects/wild-oasis-next/cabin-detail.png',
      '../images/projects/wild-oasis-next/cabin-detail2.png',
      '../images/projects/wild-oasis-next/about.png',
      '../images/projects/wild-oasis-next/auth.png',
      '../images/projects/wild-oasis-next/guest.png',
      '../images/projects/wild-oasis-next/reservation.png',
      '../images/projects/wild-oasis-next/profile.png',
    ],
  },
};
